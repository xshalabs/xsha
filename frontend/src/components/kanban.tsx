...
export const kanbanBoardColumnClassNames =
  'w-64 flex-shrink-0 rounded-md border flex flex-col border-border bg-sidebar py-2 max-h-full';
...
const kanbanBoardCardClassNames =
  'rounded-md border border-border bg-background p-3 text-start text-foreground';
